...
for i in range(k_num):
    ...
    proofreader.load_state_dict(torch.load("/net/nfs2/export/home/ohno/CR_pytorch/Culmination/Learned_models/pre_trained_proof"))
    ...
    for epoch in range(1,epochs+1):
        ...
        if epoch%10==0:
            ...
            stopwatch.start()
    torch.save(proofreader.state_dict(), "/net/nfs2/export/home/ohno/CR_pytorch/Culmination/Learned_models/proof_k"+str(i+1))
    p_val_accu_record.append(p_val_accu)
...
print(p_val_accu_record)
print(np.mean(p_val_accu_record))
