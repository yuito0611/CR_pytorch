...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self,index):
        ...
        inp = self.val_idx[index:index+9].to(device)
...
class Proofreader(nn.Module):
    def __init__(self, input_size, hidden_dim, output_size,n_layers):
        ...
        self.embedding = nn.Embedding(input_size,1024)
...
print('vector epochs 1000,learning rate 0.1')
##学習
for i in range(k_num):
    ...
    for epoch in range(1,epochs+1):
        ...
        p_loss,p_accu = train(proofreader,train_dataloader,learning_rate=0.1)
